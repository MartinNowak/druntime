...
{
    // TODO: These should only depend on the linux kernel, so maybe we
    // can merge them with the version (linux) one above.
    version (X86)
    {
        struct fenv_t
        {
    ...
    {
        static assert( false, "Unimplemented architecture" );
    }
}
else
{
